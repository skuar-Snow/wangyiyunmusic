...
if (!Array) {
  ...
  (_component_test + _easycom_uni_section2 + _easycom_uni_list_item2 + _easycom_uni_list2)();
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        l: common_vendor.unref(showSuggest)
      }, common_vendor.unref(showSuggest) ? {
        m: common_vendor.f(suggestList.value, (item, k0, i0) => {
          return {
        ...
        o: common_vendor.unref(showTable)
      }, common_vendor.unref(showTable) ? {
        p: common_vendor.f(searchTable.value, (item, k0, i0) => {
          return {
